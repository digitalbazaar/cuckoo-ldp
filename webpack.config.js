/**
 * cuckoo-ldp webpack build rules.
 *
...
// all built files will export the "cuckoo-ldp" library but with
// different content
const outputs = [
  // core cuckoo-ldp library
  {
    entry: [
